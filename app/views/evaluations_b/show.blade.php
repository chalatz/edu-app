        ...
        <div class="evaluation-summaries">
            ...
            <div class="evaluation-single-summary" id="evaluation-{{$site_index}}">
                ...
                @if($evaluation->can_evaluate == 'na')
                    <div>
                        {{ Form::model($evaluation, array('method' => 'PUT','route' => ['do_can_evaluate_b_submit', $evaluation->id], 'class' => 'pure-form pure-form-stacked', 'id' => 'confirmCanEvaluate-'.$site_index, 'name' => 'confirmCanEvaluate-'.$site_index)) }}
                ...
                @if($evaluation->can_evaluate == 'yes')                
                    @if($evaluation->is_educational == 'yes')
                        ...
                        @if($evaluation->finalized != 'yes')
                            ...
                            <div>
                                {{ Form::model($evaluation, array('method' => 'PUT','route' => ['do_comments_b_submit', $evaluation->id], 'class' => 'pure-form pure-form-stacked overflow-hidden')) }}
                    ...
                    @else
                        {{ Form::model($evaluation, array('method' => 'PUT','route' => ['do_is_educational_b_submit', $evaluation->id], 'class' => 'pure-form pure-form-stacked', 'id' => 'confirmAlpha-'.$site_index, 'name' => 'confirmAlpha-'.$site_index)) }}
