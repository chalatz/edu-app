...
@section('content')
    ...
    <p>{{ link_to_route('grader.evaluate_b_show', '&larr; Επιστροφή στις Αναθέσεις Μου') }}</p>
    ...
    {{ Form::model($evaluation, array('method' => 'PATCH','route' => ['evaluation_b.update', $evaluation->id], 'class' => 'pure-form pure-form-stacked', 'id' => 'confirmMe', 'name' => 'confirmMe')) }}
