...
@section('content')
    ...
    <p>{{ link_to_route('grader.evaluate_c_show', '&larr; Επιστροφή στις Αναθέσεις Μου') }}</p>
    ...
    {{ Form::model($evaluation, array('method' => 'PATCH','route' => ['evaluation_c.update', $evaluation->id], 'class' => 'pure-form pure-form-stacked', 'id' => 'confirmMe', 'name' => 'confirmMe')) }}
