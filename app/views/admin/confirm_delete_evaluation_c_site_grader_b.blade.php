...
@section('content')
	...
	<h1>Φάση Γ - Επιβεβαίωση Διαγραφής Ανάθεσης</h1>
    ...
    {{ Form::open(['method' => 'DELETE', 'route' => ['evaluation_c.destroy', $evaluation->id], 'class' => 'pure-form']) }}
    ...
    {{ link_to_route('admin.assign_b_to_site_c', '&larr; Επιστροφή', [$site->id]) }}
