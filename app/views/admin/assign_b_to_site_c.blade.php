...
@section('content')
	...
	<h1>Φάση Γ - Αναθέσεις Ιστότοπου σε Αξιολογητές Β</h1>
            ...
            <tbody>
                @foreach ($evaluations as $evaluation)
                    ...
                    <tr>
                        ...
                        <td>{{ link_to_route('admin.confirm_delete_evaluation_c_site_grader_b', 'Διαγραφή', [$evaluation->id], ['class' => 'red-font']) }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
    ...
    {{ Form::open(array('route' => 'evaluation_c.store', 'class' => 'pure-form pure-form-stacked')) }}
    ...
    {{ link_to_route('admin.sites_grades_c', '&larr; Επιστροφή') }}
