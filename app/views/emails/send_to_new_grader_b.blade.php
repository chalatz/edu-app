<h1 style="text-align: center">ΑΝΑΘΕΣΗ ΙΣΤΟΤΟΠΩΝ ΣΕ ΤΡΙΤΟ ΑΞΙΟΛΟΓΗΤΗ</h1>
...
<p>Σας ενημερώνουμε ότι μετά την αξιολόγηση του παρακάτω ιστότοπου, παρατηρήθηκε διαφορά βαθμολογίας >20%, και σύμφωνα με τους όρους του διαγωνισμού, καλείται και τρίτος αξιολογητής.</p>

<p>Παρακαλούμε να αποδεχτείτε την πρόσκλησή μας να αξιολογήσετε τον Ιστότοπο με τα εξής στοιχεία:</p>

<p>
    Επωνυμία Ιστότοπου: <strong>{{ $site_title }}</strong><br>
    URL: <a href="{{ $site_url }}">{{ $site_url }}</a>
</p>

<p>Σας παρακαλούμε να αποδεχτείτε την πρόσκλησή μας να αξιολογήσετε τον ιστότοπο που σας έχει ανατεθεί.</p>
...
<p>Σας παρακαλούμε να έχετε συνδεθεί <strong>μέσα στις επόμενες 2 ημέρες</strong> και να αποδεχτείτε να αξιολογήσετε τον ιστότοπο που σας έχει ανατεθεί.</p>

<p>Εάν υπάρχει πολύ σοβαρός λόγος για την αυτο-εξαίρεσή σας, έχετε τη δυνατότητα <strong>μέσα στις επόμενες 2 ημέρες</strong> να δηλώσετε ότι δεν μπορείτε να αναλάβετε την αξιολόγηση αυτού του ιστότοπου για αυτό το λόγο και να σας αλλάξουμε τον ιστότοπο.</p>
